...
const Products = () => {
  const listLlantas = llantas.map((link: any) => {
    return (
      <React.Fragment>
        <ProductItem
          key={link.id}
  ...
  const listSistemaArrastre = sistemaArrastre.map((link: any) => {
    return (
      <React.Fragment>
        <ProductItem
          key={link.id}
  ...
  const listSistemaElectrico = sistemaElectrico.map((link: any) => {
    return (
      <React.Fragment>
        <ProductItem
          key={link.id}
  ...
  const listSistemaMotor = sistemaMotor.map((link: any) => {
    return (
      <React.Fragment>
        <ProductItem
          key={link.id}
  ...
  const listLuces = luces.map((link: any) => {
    return (
      <React.Fragment>
        <ProductItem
          key={link.id}
  ...
  const listAccesorioMotor = accesoriosMotor.map((link: any) => {
    return (
      <React.Fragment>
        <ProductItem
          key={link.id}
  ...
  const listAccesorioPiloto = accesoriosPiloto.map((link: any) => {
    return (
      <React.Fragment>
        <ProductItem
          key={link.id}
  ...
  const listSistemaFrenos = sistemaFrenos.map((link: any) => {
    return (
      <React.Fragment>
        <ProductItem
          key={link.id}
      ...
      <section className="section-p section-1">
        <Container fluid="xxl">
          <div className="portal-phrase">
            <h1 className="portal-title">Descubre nuestros productos</h1>
            <p className="portal-subtitle">Explora nuestro catalogo</p>
          </div>
        </Container>
      </section>
      <section className="category-menu-container">
        <Container>
          <div className="category-menu-list marquee">
            <HashLink
              to="/products/#llantas"
              className="category-menu-item__link"
            >
              Llantas
            </HashLink>
            <HashLink
            ...
            <Col sm={9}>
              <Tab.Content>
                <Tab.Pane eventKey="1">
                  ...
                  <div className="products">{listLlantas}</div>
                </Tab.Pane>
                <Tab.Pane eventKey="2">
                  <h2 id="sistema-arrastre">Sistema de arrastre</h2>
                  <div className="products">{listSistemaArrastre}</div>
                </Tab.Pane>
                <Tab.Pane eventKey="3">
                  <h2 id="sistema-electrico">Sistema electrico</h2>
                  <div className="products">{listSistemaElectrico}</div>
                </Tab.Pane>
                <Tab.Pane eventKey="4">
                  <h2 id="sistema-motor">Sistema de motor</h2>
                  <div className="products">{listSistemaMotor}</div>
                </Tab.Pane>
                <Tab.Pane eventKey="5">
                  <h2 id="luces">Luces</h2>
                  <div className="products">{listLuces}</div>
                </Tab.Pane>
                <Tab.Pane eventKey="6">
                  <h2 id="accesorios-motor">Accesorios para motor</h2>
                  <div className="products">{listAccesorioMotor}</div>
                </Tab.Pane>
                <Tab.Pane eventKey="7">
                  <h2 id="accesorios-piloto">Accesorios para piloto</h2>
                  <div className="products">{listAccesorioPiloto}</div>
                </Tab.Pane>
                <Tab.Pane eventKey="8">
                  <h2 id="sistemas-frenos">Sistema de frenos</h2>
                  <div className="products">{listSistemaFrenos}</div>
                </Tab.Pane>
              </Tab.Content>
            </Col>
          </Row>
